...
class EquiposControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create equipo" do
    assert_difference('Equipo.count') do
      post equipos_url, params: { equipo: { estadio: @equipo.estadio, mascota: @equipo.mascota, nombre: @equipo.nombre } }
    end
  ...
  test "should update equipo" do
    patch equipo_url(@equipo), params: { equipo: { estadio: @equipo.estadio, mascota: @equipo.mascota, nombre: @equipo.nombre } }
